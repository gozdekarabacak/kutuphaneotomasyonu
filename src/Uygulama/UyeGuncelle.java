...
public class UyeGuncelle extends javax.swing.JFrame {

    public UyeGuncelle() {
        initComponents();
        txtKullaniciAdi.setText(Login.kullaniciAdi);
        txtSifre.setText(Login.kullaniciSifre);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Uye Guncelleme Formu");

        jLabel3.setText("Kullanıcı Adı :");

        jLabel4.setText("Şifre : ");

        btnKayitOl.setText("GUNCELLE");
    ...
    private void btnKayitOlActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKayitOlActionPerformed
        ...
        DB db = new DB();
        try {
            String query = "UPDATE kullanici SET kullanici_adi = '"+uyeler.getKullanici_adi()+"',kullanici_sifre = '"+uyeler.getKullanici_sifre()+"' WHERE kullanici_adi = '"+Login.kullaniciAdi+"' AND kullanici_sifre = '"+Login.kullaniciSifre+"'";
            int ekle = db.baglan().executeUpdate(query);
            if (ekle > 0) {
                JOptionPane.showMessageDialog(this, "Üye Güncelleme Başarılı Gerçekleştirilmiştir..");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UyeGuncelle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UyeGuncelle().setVisible(true);
            }
        });
    }
